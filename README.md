...
## Project Goals
- Development of a Verification Framework for Applying and Validating an Additional Metadata Structure to AI-Generated Content Produced by Commercial LLM APIs
- 상용 LLM AI API의 AI 산출물에 대한 추가 설계 메타데이터 구조 적용 및 검증 프레임워크 개발
